...
<html lang="en">
    ...
    <body class="loading authentication-bg" data-layout-config='{"leftSideBarTheme":"dark","layoutBoxed":false, "leftSidebarCondensed":false, "leftSidebarScrollable":false,"darkMode":false, "showRightSidebarOnStart": true}'>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="text-center w-75 m-auto">
                                    ...
                                    <p class="text-muted mb-4">Welcome Superadmin !</p>
                                </div>
                                ...
                                <form action="{{ route('superadmin.login') }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        <a href="{{ route('superadmin.password.request') }}" class="text-muted float-right"><small>Forgot your password?</small></a>
        ...
        <footer class="footer footer-alt">
            <script>document.write(new Date().getFullYear())</script> © Traqworx
        </footer>
